...
**Tsool JSON** es un editor visual de estructuras JSON que se ejecuta completamente en el navegador. Permite a usuarios, incluso sin conocimientos de programación, visualizar, modificar, limpiar y estructurar documentos JSON complejos a través de una interfaz amigable e intuitiva.
...
* **Sin Backend:** Todo el procesamiento ocurre en el cliente (Client-Side) utilizando la API de Archivos del navegador. Tus datos nunca salen de tu computadora.
* **Live Preview:** Visualiza el código JSON crudo en tiempo real mientras realizas cambios visuales.
* **Tipado Automático:** Detecta y respeta tipos de datos (Strings, Numbers, Booleans).
* **CRUD Completo:**
...
* **[Tailwind CSS v4](https://tailwindcss.com/):** Motor de estilos de próxima generación (configuración nativa CSS).
...
1.  Asegúrate de tener la propiedad `homepage` en tu `package.json`.
